//
//  BusquedaDetallleViewController.swift
//  CelularesPeru
//
...
class BusquedaDetallleViewController: UIViewController {
    ...
    @IBOutlet weak var imagecel4: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        imagecel3.image = imagecel4.image
        imagecel4.image = imagecel5.image
    ...
    func pintarImage() {
        ...
        consumirImage(image: imagecel4, data: stringImage[3])
    ...
    @IBAction func botton3(_ sender: Any) {
        imagePrueba.image = imagecel1.image
        imagecel1.image = imagecel4.image
        imagecel4.image = imagePrueba.image
    }
